 ...
 *****************************************************************************/
/*!
 * \struct dvbpsi_vct_channel_s
 * \brief VCT channel structure.
 *
 * This structure is used to store a decoded VCT channel information.
 */
/*!
 * \typedef struct dvbpsi_vct_channel_s dvbpsi_vct_channel_t
 * \brief dvbpsi_vct_channel_t type definition.
 */
typedef struct dvbpsi_vct_channel_s
{
    ...
    struct dvbpsi_vct_channel_s *p_next;         /*!< next element of the list */
} dvbpsi_vct_channel_t;
 ...
 */
/*!
 * \typedef struct dvbpsi_vct_s dvbpsi_vct_t
 * \brief dvbpsi_vct_t type definition.
 */
typedef struct dvbpsi_vct_s
{
    ...
    dvbpsi_vct_channel_t   *p_first_channel;    /*!< First channel information structure. */
 ...
 *****************************************************************************/
/*!
 * \typedef void (* dvbpsi_vct_callback)(void* p_cb_data,
                                         dvbpsi_vct_t* p_new_vct)
 * \brief Callback type definition.
 */
typedef void (* dvbpsi_vct_callback)(void* p_cb_data, dvbpsi_vct_t* p_new_vct);
 ...
 *****************************************************************************/
/*!
 * \fn void dvbpsi_AttachVCT(dvbpsi_demux_t * p_demux, uint8_t i_table_id,
 ...
 */
int dvbpsi_AttachVCT(dvbpsi_decoder_t * p_psi_decoder, uint8_t i_table_id, 
          uint16_t i_extension, dvbpsi_vct_callback pf_callback, void* p_cb_data);
 ...
 *****************************************************************************/
/*!
 * \fn void dvbpsi_DetachVCT(dvbpsi_demux_t * p_demux, uint8_t i_table_id)
 *
 ...
 * \return nothing.
 */
void dvbpsi_DetachVCT(dvbpsi_demux_t * p_demux, uint8_t i_table_id, 
          uint16_t i_extension);


/*****************************************************************************
 * dvbpsi_InitVCT/dvbpsi_NewVCT
 *****************************************************************************/
/*!
 * \fn void dvbpsi_InitVCT(dvbpsi_vct_t* p_vct, uint8_t i_version, 
        int b_current_next, uint8_t i_protocol)
 * \brief Initialize a user-allocated dvbpsi_vct_t structure.
...
/*!
 * \def dvbpsi_NewVCT(p_vct, i_network_id, i_version, b_current_next)
 ...
 * \return nothing.
 */
#define dvbpsi_NewVCT(p_vct, i_version, b_current_next, i_protocol,     \
            i_ts_id, b_cable_vct)                                       \
do {                                                                    \
  p_vct = (dvbpsi_vct_t*)malloc(sizeof(dvbpsi_vct_t));                  \
  if(p_vct != NULL)                                                     \
    dvbpsi_InitVCT(p_vct, i_version, b_current_next, i_protocol,        \
        i_ts_id, b_cable_vct);                                          \
} while(0);


/*****************************************************************************
 * dvbpsi_EmptyVCT/dvbpsi_DeleteVCT
 *****************************************************************************/
/*!
 * \fn void dvbpsi_EmptyVCT(dvbpsi_vct_t* p_vct)
...
/*!
 * \def dvbpsi_DeleteVCT(p_vct)
 * \brief Clean and free a dvbpsi_vct_t structure.
 * \param p_vct pointer to the VCT structure
 * \return nothing.
 */
#define dvbpsi_DeleteVCT(p_vct)                                         \
do {                                                                    \
  dvbpsi_EmptyVCT(p_vct);                                               \
  free(p_vct);                                                          \
} while(0);
