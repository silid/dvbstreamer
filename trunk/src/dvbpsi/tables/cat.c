 ...
 * $Id: cat.c 146 2007-10-11 06:45:21Z jpsaman $
 *
                              ...
                              dvbpsi_psi_section_t* p_section)
{
  ...
  if(b_reinit)
  {
    ...
    for(i = 0; i <= 255; i++)
    {
      ...
      {
        dvbpsi_ReleasePSISections(p_decoder, p_cat_decoder->ap_sections[i]);
        p_cat_decoder->ap_sections[i] = NULL;
      }
    }
  }
  ...
  if(b_append)
  {
    ...
    if(p_cat_decoder->ap_sections[p_section->i_number] != NULL)
    {
      DVBPSI_DEBUG_ARG("CAT decoder", "overwrite section number %d",
                       p_section->i_number);
      dvbpsi_ReleasePSISections(p_decoder, p_cat_decoder->ap_sections[p_section->i_number]);
    }
    ...
    if(b_complete)
    {
      ...
      /* Delete the sections */
      dvbpsi_ReleasePSISections(p_decoder, p_cat_decoder->ap_sections[0]);
      /* signal the new CAT */
